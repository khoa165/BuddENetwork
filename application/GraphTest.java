...
class GraphTest {
	...
	/**
	 * This method tests to see if a DuplicateUserException is thrown when
	 * vertex already in graph is attempted to be added
	 */
	@Test
	...
	/**
	 * This test checks to see that an edge is not added to the graph when one
	 * of the arguments is null by checking that an IllegalNullArgumentException
	 * is thrown and that the size of the graph is not incremented by one.
	 */
	@Test
	...
	/**
	 * This test checks that an edge in the graph has been removed from the
	 * graph by checking that the size of the graph decreases by one.
	 *
	 */
	@Test
	...
	/**
	 * This test checks that an IllegalArgumentException is thrown and the size
	 * of the graph does not change when an edge that contains a null vertex is
		...
		try {
			...
			if (!correctAdj.equals(allAdj)) {
				fail("Correct adjacent vertices list for the grpah is not returned from"
						+ " method. Correct list is " + correctAdj
						+ ", but returned " + allAdj);
			}
		}
	}
	...
	/**
	 * This method tests that the correct User is returned for a a given
	 * username when the user is in the graph.
	 */
	@Test
	...
	/**
	 * This method tests that null is returned for a a given username when it
	 * does not correspond to a user in the graph.
	 */
	@Test
